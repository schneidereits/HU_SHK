...
print(paste("number of observations following SHS method for QAI filtering:", nrow(fs_LND_filtered)) )
print(paste("number of observations following KK method QAI filtering:", nrow(raw_fs_KK)) )
